...
let html=await readFile(new URL('index.html',web),'utf8');html=html.replace('href="/web/style.css"','href="./style.css?v=20260915-flight1"')
 ...
 .replace('<script type="module" src="/web/main.js"></script>','<script src="./demo-api.js?v=20260915-flight1"></script><script type="module" src="./main.js?v=20260915-flight1"></script>');
